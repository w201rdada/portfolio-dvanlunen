...
```{r vid,echo=FALSE,fig.cap='Why Pin-Perfect Wedding?\nRequires Bmail sign in',fig.align='center'}
knitr::include_url('https://drive.google.com/file/d/1JW4kHGLETVNHwX-h0sAeRWAg86ZHvZ6X/preview')
```
